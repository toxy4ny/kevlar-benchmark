...
class IdentityOrchestrator:
    ...
    def _detect_confused_deputy(self, session):
        ...
        return detector.detect_deputy_escalation(session.tool_calls, session.identity_context)
    ...
    def _detect_toctou(self, session):
        detector = PrivilegeEscalationDetector()
        return detector.detect_toctou_escalation(session.session_token, session.escalated_actions)
