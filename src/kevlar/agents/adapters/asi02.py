"""LangChain agent adapter for ASI02: Tool Misuse and Exploitation.

Compatible with all 9 ASI02 attack scenarios from OWASP Top 10
for Agentic Apps 2026.
"""
...
class LangChainASI02Agent:
    """Specialized agent for ASI02 tool misuse testing."""
